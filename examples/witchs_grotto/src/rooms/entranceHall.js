...
import { getSouthHall } from "./southHall";
import { initGarden } from "./garden";
import { MagicWord } from "../magic/magicWord";

let entranceHall;

export const initEntranceHall = () => {
  entranceHall = new Room(
    "Entrance Hall",
  ...
  entranceHall.setSouth(getSouthHall());
  entranceHall.setNorth(initGarden());
  return entranceHall;
};
