...
import { initSouthHall } from "./southHall";
import { initWitch } from "./garden";
...
You see a rickety door to the North and a white painted door leading East.`
  ...
  const cupboardNodes = [
    ...
    {
      id: "leave",
      actions: "You quietly slip out of the cupboard, trying not to let the door squeak."
    },
    {
      id: "peek",
      actions: () => {
