...
let bookShelf, druidicPeoples;

export const getBookShelf = () => bookShelf;
export const getDruidicPeoples = () => druidicPeoples;
...
export const initBookShelf = () => {
  ...
  druidicPeoples.verbs.give.test = (helper, item, other) => other.aliases.includes("cat");
