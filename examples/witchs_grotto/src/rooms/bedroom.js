...
export const getBedroom = () => {
  return bedroom;
};

export const initBedroom = () => {
  bedroom = new Room(
    "Bedroom",
  ...
  paperBag.addAction("give", () => getCatGraph().commence("giveTreats"), false, true);
  ...
  const keepsakeBox = newContainer({
    name: "keepsake box",
    aliases: ["jewellery"],
    closedDescription: () => {
    ...
    openDescription: "The box lies open, its lid hinged back, revealing a rectangular compartment inside.",
    capacity: 1,
    proposition: "in",
    locked: true,
    open: false,
  ...
  const miaowResults = new RandomText(
    '"Miiaaoow," you say, doing your very best cat impression. You fight the urge to shake your tail. Wait...you don\'t have a tail.',
    'Making your voice as high-pitched and catlike as you possibly can, you let out an extremely convincing "Miiaaoow!" It\'s all you can do to keep yourself from purring afterwards.',
