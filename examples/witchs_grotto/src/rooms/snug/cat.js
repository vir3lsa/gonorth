...
import { getBookShelf, getDruidicPeoples } from "../apothecary/bookshelf";
...
export const getCatGraph = () => {
  return catGraph;
};

export const initCatGraph = () => {
  store("catName", "Sir");
  ...
  const catTalkNodes = [
    ...
    },
    {
      ...
      actions: [
        () => {
          update("catName", "Mister Cat");
          cat.name = "Mister Cat";
          return null;
        },
        () => `"Nice to meet you, ${retrieve("catName")}."\n\nThe cat appears to wince, then nods for you to go on.`
      ],
      options: {
        "Find key": "findKey",
        "How to escape": "escape",
    ...
    },
    {
      ...
      actions: [
        () => {
          update("catName", "Mister Snugglesworth");
    ...
    },
    {
      ...
      actions: () =>
        new SequentialText(
          ...
          `${retrieve("catName")} eyes you suspiciously. "Yes. Well. Where were we?"`
        ),
      options: {
        "Find key": "findKey",
        "How to escape": "escape",
    ...
    },
    {
      ...
      actions: () =>
        new SequentialText(
          `Do you know where...Mildred...keeps the key, ${retrieve("catName")}?`,
          `${retrieve(
            "catName"
          )} shakes his head emphatically, his white whiskers swishing back and forth. "You can forget that idea straight away, Jenner. She keeps the key on her all the time and there's no way you'd be able to snatch it, I'm afraid to say. Use that oversized two-legger brain of yours to find another solution."`
        ),
      options: {
        "How to escape": "escape",
        "Need fur": "needFur",
    ...
    },
    {
      id: "escape",
      actions: [
        () => (getBookShelf().hidesItems = [...getBookShelf().hidesItems, getDruidicPeoples()]),
        () =>
          new SequentialText(
            `"Like I said, ${retrieve(
              "catName"
            )}, I really need to get home. Mother will give me a scalding already and if I get much later..." You make your eyes big and round. "You must know how to get out of here. Please - help me."`,
    ...
    },
    {
      ...
      actions: () =>
        new SequentialText(
          `"Okay, ${retrieve("catName")}," you say, uncertainly. "I'll see if I can find the book."`,
    ...
    },
    {
      ...
      actions: () =>
        new SequentialText(
          `"Please, ${retrieve("catName")}, could I have some of your fur?" you ask in your meekest voice.`,
          ...
          `"Please, ${retrieve(
            "catName"
          )}! I need it! To help me escape!" You jump up and down to emphasise the point.`,
    ...
    },
    {
      ...
      actions: () =>
        new SequentialText(
          `"Oh, thank you, ${retrieve("catName")}! I'll go and find the treats for you. Just wait there, okay?"`,
    ...
    },
    {
      ...
      actions: () =>
        new SequentialText(
          ...
          `With surprising dexterity for a creature with no fingers, ${retrieve(
            "catName"
          )} picks up the book and starts flicking through the pages, muttering to himself.`,
          ...
          `You look at ${retrieve("catName")} blankly. "I don't understand."`,
    ...
    },
    {
      ...
      actions: () =>
        new SequentialText(
          `"Thank you, ${retrieve("catName")}," you say, with genuine gratitude. "I'll go and find this labberinse."`,
          `"Lab-y-rinth," ${retrieve("catName")} corrects you, not unkindly.`,
          `"Yes. Labyrint. Bye!"`
        )
    },
    {
    ...
    },
    {
      ...
      actions: () =>
        new SequentialText(
          `You clear your throat. "Um, excuse me, ${retrieve("catName")}..."`,
          `${retrieve("catName")} continues his ravenous consumption, showing no sign of having heard you.`,
          `${retrieve(
            "catName"
      ...
      actions: [
        ...
        () =>
          new SequentialText(
            ...
            `Trying not to let your faint disgust show, you take the fur from his outstretched paw. "Thank you, ${retrieve(
              "catName"
            )}."`,
            `"Think nothing of it, Jenner. I only hope it aids you in your escape."`,
            `"Me too. Goodbye, ${retrieve("catName")}."`,
  ...
  const speak = new Verb(
    ...
    [
      () => {
        catGraph.getNode("greeting").options["Spoke to you before"] = "spokeBefore";
        return null;
      },
      new SequentialText(
