...
import { getBedroom } from "./bedroom";

let staircase;

export const getStaircase = () => {
  return staircase;
};

export const initStaircase = () => {
  ...
  const turnAround = new Verb(
    ...
    () => {
      if (getRoom().name === "Staircase") {
        ...
        return `You turn around to face the other way. You're now looking ${
          facingBackwards ? "down" : "up"
        } the stairs.`;
      } else {
