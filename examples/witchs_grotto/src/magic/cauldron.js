...
import { initPentagram } from "./pentagram";

let alchemy, cauldron, contents, tap, fire;

export const getAlchemy = () => alchemy;
export const getCauldron = () => cauldron;
export const getContents = () => contents;
export const getTap = () => tap;
export const getFire = () => fire;

export const initCauldron = () => {
  // Our alchemy instance for the apothecary
  alchemy = new Alchemy(initPentagram());

  let describeCauldronContents;

  cauldron = new Item("cauldron", () => {
    const basic =
  ...
  describeCauldronContents = () => {
    ...
    const baseAdded = alchemy.waterLevel > 0 || alchemy.fatLevel > 0 || alchemy.bloodLevel > 0;
  ...
  contents = new Item("cauldron contents", () => describeCauldronContents());
