import { selectPlayer } from "../../../../lib/gonorth";
import { Potion } from "./alchemy";
import { DRINK, potionEffects } from "./magicEffects";

export const philtreOfFelineVision = new Potion(
...
potionEffects.add(
  philtreOfFelineVision,
  DRINK,
  true,
  () => (selectPlayer().felineVision = true),
