...
export const selectEventTimeoutOverride = (): number => getStore().getState().eventTimeoutOverride;
export const selectEventTurnsOverride = (): number => getStore().getState().eventTurnsOverride;
